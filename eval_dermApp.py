...
print("===> time for preparation: " + str(t_prep_end-t_prep_begin))
...
def eval():
    ...
    for batch in testing_data_loader:
        ...
        save_img(prediction.cpu().data, "super_res", False)
...
print("eval time: "  + str(t_eval_end-t_eval_begin))
print("total time: "  + str(t_end-t_begin))